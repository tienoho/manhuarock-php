...
<div class="wrapper">
    ...
    <div class="navbar-expand-md">
        <div class="collapse navbar-collapse" id="navbar-menu">
            <div class="navbar navbar-light">
                <div class="container-xl">
                    <ul class="navbar-nav">
                        <li class="nav-item {{ url() === url('auto-tool') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ url('auto-tool') }}">
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                      ...
                      Dashboard
                        ...
                        <li class="nav-item {{ url() === url('auto-tool', ['campaign']) ? 'active' : '' }}">
                            <a class="nav-link" href="{{ url('auto-tool', ['campaign']) }}">
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
   ...
   <circle cx="12" cy="9" r="2"></circle>
                      ...
                      Campaign
                        ...
                        <li class="nav-item {{ url() === url('auto-tool', ['cron-manage']) ? 'active' : '' }}">
                            <a class="nav-link" href="{{ url('auto-tool', ['cron-manage']) }}">
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
...
<script src="/admin/js/auto-manga.js?v={{ filemtime(ROOT_PATH . '/public/admin/js/auto-manga.js') }}"></script>
