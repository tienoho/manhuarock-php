    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Config Campaign: {{ $name }}
                </h5>
            ...
            <div class="modal-body">
                <form>
                    <input hidden="hidden" value="{{ $name }}" name="name">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="server_image">
                                    @foreach($ImageServers as $imgsv)
                                        <option value="{{ $imgsv }}" {{ $private_config['server_image'] === $imgsv ? 'selected=""' : '' }}>{{ $imgsv }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="save_poster_to_remote">
                                    @foreach($ImageServers as $imgsv)
                                        <option value="{{ $imgsv }}" {{ $private_config['save_poster_to_remote'] === $imgsv ? 'selected=""' : '' }}>{{ $imgsv }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-lg-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="max_process_running"
                                       value="{{ $private_config['max_process_running'] }}">
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="max_page_update"
                                       value="{{ $private_config['max_page_update'] }}">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <div class="mb-3">
                                    <div>
                                        <label class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" name="save_poster" @if($private_config['save_poster']) checked=""@endif>
                                            <span class="form-check-label">Save Poster</span>
                                        </label>
                                        <label class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" @if($private_config['using_multi_upload']) checked=""@endif disabled="">
                            ...
                            <div class="col-lg-6">
                                <label class="form-selectgroup-item mb-2">
                                    <input type="radio" name="only_update" value="1" class="form-selectgroup-input"
                                           @if($private_config['only_update']) checked=""@endif>
