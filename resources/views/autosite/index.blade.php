   ...
   <line x1="10" y1="12" x2="14" y2="12"></line>
                                ...
                                <div class="col">
                                    ...
                                    <div class="text-muted">
                                        {{ Models\Model::getDB()->where('done', 0)->getOne('auto_logs', 'COUNT(id) as total')['total'] }}
                                        records
                                    </div>
                                </div>
                            </div>
...
<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-hammer" width="24" height="24"
   ...
   <path d="M18.121 15.293l2.586 -2.586a1 1 0 0 0 0 -1.414l-7.586 -7.586a1 1 0 0 0 -1.414 0l-2.586 2.586a1 1 0 0 0 0 1.414l7.586 7.586a1 1 0 0 0 1.414 0z"></path>
                                ...
                                <div class="col">
                                    ...
                                    <div class="text-muted">
                                        {{ Models\Model::getDB()->where('done', 1)->getOne('auto_logs', 'COUNT(id) as total')['total'] }}
                                        records
                                    </div>
                                </div>
                            </div>
   ...
   <circle cx="12" cy="9" r="2"></circle>
                                ...
                                <div class="col">
                                    ...
                                    <div class="text-muted">
                                        {{ count((new CrawlHelpers())->scraplist()) }} campaign
                                    </div>
                                </div>
                            </div>
                        </div>
...
<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-notes" width="24" height="24"
   ...
   <line x1="9" y1="15" x2="13" y2="15"></line>
                                ...
                                <div class="col">
                                    ...
                                    <div class="text-muted">
                                        {{ Models\Model::getDB()->getOne('crawl_queue', 'COUNT(id) as total')['total'] }}
                                        waitings
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-table table-responsive">
                            <table class="table table-vcenter">
                                ...
                                <tbody>
                                @foreach(Models\Model::getDB()->objectBuilder()->get('crawl_queue') as $queue)
                                    <tr>
                                        <td>
                                           {{ $queue->url }}
                                            <a href="{{ $queue->url }}" target="_blank" class="ms-1" aria-label="Open website">
                                        ...
                                        <td class="text-muted">{{ $queue->source }}</td>
                                        <td class="text-muted">@if($queue->running)<span class="badge bg-success me-1"></span> Running @else <span class="badge bg-warning me-1"></span> Waiting @endif</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-actions">
                                        <a href="{{ path_url('autotool') . 'configuration' }}">
                                            Edit configuration
                                ...
                                <div class="card-body">
                                    <dl class="row">
                                        ...
                                        <dd class="col-7">{{ $tool_config->server_image }}</dd>

                                        <dt class="col-5">Type Crawl:</dt>
                                        <dd class="col-7">{{ ($tool_config->only_update ? 'Only Update Chap' : 'Crawl ALL')  }}</dd>
                                        <dt class="col-5">Re-Crawl:</dt>
                                        <dd class="col-7">{{ $tool_config->max_page_update }} pages</dd>

                                        <dt class="col-5">Running:</dt>
                                        <dd class="col-7">{{ $tool_config->max_process_running }} process same time</dd>
