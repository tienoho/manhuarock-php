                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ url('admin.manga-add') }}" class="btn btn-sm btn-success"><i class="fas fa-plus"></i> Thêm
                                    </a>
                                </div>
                            </div>
                            <!-- /.card-header -->
    ...
    <script>
        ...
        var table = $("#table").DataTable({
            ...
            "columnDefs": [
                ...
                {
                    "render": function ( data, type, row ) {
                        return `<a href="{{ url('admin.manga-edit') }}/${row['id']}">${data}</a>`;
                    },
                    "targets": 1
                },
                {
                ...
                {
                    "render": function (data, type, row) {
                        return `<a href="{{ url('admin.chapter-add') }}/${data}" class="btn btn-primary btn-sm">Thêm</a> <a href="{{ url('admin.manga-edit') }}/${data}" class="btn btn-info btn-sm">Sửa</a> <a class="btn btn-danger btn-sm delete-manga" data-id="${data}">Xoá</a>`;
                    },
                    "targets": 6
                },
                {
