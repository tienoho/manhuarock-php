                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <a href="{{ url("admin.manga-manage") }}" class="small-box-footer">More info <i
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                @if($user->total  < 0 || $visitor->total < 0)
                                    <h3>{{ round(($user->total / $visitor->total) * 100, 2) }}<sup
