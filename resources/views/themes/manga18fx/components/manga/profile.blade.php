                ...
                <div class="summary_content">
                    <div class="post-content">
                        ...
                        <div id="init-links" class="nav-links">
                            @if(!empty($chapters))
                                <a id="btn-read-first" class="c-btn c-btn_style-1" href="{{ url("chapter", [ 'm_slug' => $manga->slug, 'c_slug' => $chapters[count($chapters) - 1]->slug, 'c_id' => $chapters[count($chapters) - 1]->id]) }}">
                                    {{ L::_("Read First") }}
                                </a>
                                <a id="btn-read-last" class="c-btn c-btn_style-1" href="{{ url("chapter", [ 'm_slug' => $manga->slug, 'c_slug' => $chapters[0]->slug, 'c_id' => $chapters[0]->id]) }}">
                                    {{ L::_("Read Last") }}
                                </a>
                            @else
