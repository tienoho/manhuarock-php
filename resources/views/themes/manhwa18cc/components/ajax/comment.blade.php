            ...
            <div class="info">
                ...
                <div class="ibottom">
                    <div class="ib-li ib-reply" data-id="{{ $comment->id }}">
                        <a class="btn"><i class="fas fa-reply mr-1"></i>{{ L::_('Reply') }}</a>
                    </div>
                    ...
                    <div class="ib-li">
                        <a class="btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-ellipsis-h mr-1"></i>{{ L::_('More') }}</a>
                        <div class="dropdown-menu dropdown-menu-model dropdown-menu-normal" aria-labelledby="ssc-list">
                            ...
                            <a class="dropdown-item cm-report" href="javascript:(0);" data-type="2"
                               data-id="{{ $comment->id }}">{{ L::_('Report Spoil') }}</a>
                        </div>
                    </div>
                    @if(is_login())
                                ...
                                <form class="preform preform-dark comment-form">
                                    ...
                                    <div class="ci-buttons">
                                        ...
                                        <div class="ci-b-right">
                                            ...
                                            <div class="cb-li">
                                                <button class="btn btn-sm btn-primary ml-2">{{ L::_('Reply') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                ...
                <div class="replies">
                    <div class="rep-more rep-in">
                        <button type="button" class="btn btn-sm cm-btn-show-rep" data-id="{{ $comment->id }}">
                            <i class="fas fa-caret-down mr-2"></i><span>{{ count($replys) }} {{ L::_('replies') }}</span>
                        </button>
                    </div>
