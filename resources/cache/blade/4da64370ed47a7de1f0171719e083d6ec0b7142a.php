    ...
    <div class="content-wrapper">
        ...
        <section class="content" style="min-height: 1000px;">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="add-chap" action="<?php echo e(url('api.chapter-add', ['m_id' => $manga->id])); ?>" method="POST"
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\PHP\HMT\resources\views/admin/pages/chapter_add.blade.php ENDPATH**/ ?>