<?php if($chapter_data->type === 'image'): ?>
    ...
    <?php $__currentLoopData = $chapter_data->content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="image-placeholder">
            <img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-index="<?php echo e($key); ?>" class="lazyload" data-src="<?php echo e($image); ?>" loading="lazy" alt="Page <?php echo e($key); ?>">
        </div>
...
<?php endif; ?><?php /**PATH F:\PHP\HMT\resources\views/themes/kome/components/chapter/vertical-image-list.blade.php ENDPATH**/ ?>