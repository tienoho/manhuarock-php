<div id="main-content">
                ...
                <ul class="nav nav-tabs pre-tabs pre-tabs-min">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab"
                           href="#latest-update"><?php echo e(L::_('Latest Updated')); ?></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="tab-content">
            <div class="tab-pane active show" id="latest-update">
                <div class="manga_list-sbs">
                    <div class="mls-wrap">
                        <?php $__currentLoopData = (new Models\Manga())->new_update(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="tab-pane" id="latest-manga">
                <div class="manga_list-sbs">
                    <div class="mls-wrap">
                        <?php $__currentLoopData = (new Models\Manga())->new_manga(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item item-spc">
                                <a class="manga-poster"
                                   href="<?php echo e(url('manga', ['m_slug' => $manga->slug, 'm_id' => $manga->id])); ?>">
    ...
    <div class="clearfix"></div>
</div><?php /**PATH D:\ANHNGHIA\HoiMeTruyen\resources\views/themes/mangareader/components/home/main-content.blade.php ENDPATH**/ ?>