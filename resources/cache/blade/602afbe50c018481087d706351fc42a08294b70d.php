...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content" style="min-height: 1000px;">
            <form id="my-form" action="<?php echo e(url('api.manga-add')); ?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class=" col-lg-9">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="inputStatus" class="form-control custom-select">
                                        ...
                                        <option value="<?php echo e($slug); ?>"><?php echo e($status); ?></option>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/v2.manhuarockz.com/resources/views/admin/pages/manga_add.blade.php ENDPATH**/ ?>