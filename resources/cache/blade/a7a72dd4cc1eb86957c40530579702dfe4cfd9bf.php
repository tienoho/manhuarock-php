<div class="history-lists row">
    <?php $__currentLoopData = $mangas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="history-item mt-3 col-12 col-md-6">
            <div class="row">
                ...
                <div class=" col-md-9 col-8 pl-0">
                    ...
                    <div class="continue"><span
                                class="font-weight-bold"><?php echo e(L::_("Continue")); ?>:</span> <a
...
<?php /**PATH D:\ANHNGHIA\HoiMeTruyen\resources\views/themes/kome/template/history-page.blade.php ENDPATH**/ ?>