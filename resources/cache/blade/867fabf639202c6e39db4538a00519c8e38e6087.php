<section class="block_area block_area_featured">
    <div class="block_area-header">
        <div class="bah-heading">
            <h2 class="cat-heading"><?php echo e(L::_('OnGoing')); ?></h2>
        </div>
        ...
        <div class="featured-list featured-03">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    $CachedString = $Cache->getItem('ongoing.home');
                    if(!$CachedString->isHit()){
                        $data = (new Models\Manga())->ongoing(1, 24, 'RAND()');
...
</section><?php /**PATH D:\ANHNGHIA\HoiMeTruyen\resources\views/themes/mangareader/components/home/completed.blade.php ENDPATH**/ ?>