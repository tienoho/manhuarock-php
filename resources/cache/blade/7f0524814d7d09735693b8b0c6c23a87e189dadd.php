    ...
    <div class="container">
        <div class="sh-left">
            <div class="float-left">
                <a class="sh-item" href="<?php echo e(url('user.request-permission')); ?>"><i class="fas fa-glasses mr-2"></i><?php echo e(L::_('Upload Manga')); ?></a>
            </div>
        ...
        <div class="sh-right">
            <div class="float-left">
                ...
                <a class="sh-item mr-3" href="https://www.reddit.com/r/MangaReaderOfficial" target="_blank"><i class="fab fa-reddit-alien mr-2"></i>Reddit</a>
                <a class="sh-item mr-3" href="https://twitter.com/WeMangaReader" target="_blank"><i class="fab fa-twitter mr-2"></i>Twitter</a>
                <a class="sh-item" href="https://discord.gg/Bvc5mVcUqE" target="_blank"><i class="fab fa-discord mr-2"></i>Discord</a>
                <div class="clearfix"></div>
            </div>
...
<div class="<?php echo $__env->yieldContent('header-class'); ?>" id="header">
    <div class="container">
        ...
        </div><a href="/" id="logo"><img alt="logo" src="/mangareader/images/logo.png">
...
</script><?php /**PATH D:\ANHNGHIA\HoiMeTruyen\resources\views/themes/mangareader/components/header.blade.php ENDPATH**/ ?>