<div id="header" class="header-reader">
    <div class="container">
        <div class="auto-div">
            ...
            <a title="<?php echo e($manga->name); ?>" href="<?php echo e(url('manga', ['m_id' => $manga->id, 'm_slug' => $manga->slug])); ?>" class="hr-manga">
            ...
            <div class="hr-navigation" style="display: none;">
                <div class="rt-item rt-read" style="display: none">
                    <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                        ...
                        <span class="m-show">Ảnh Vip</span><i class="fas fa-angle-down ml-2"></i>
                    </button>
            ...
            <div class="float-right hr-right">
                ...
                <div class="hr-setting mr-2" style="display: none">
                    <a class="btn btn-sm hrr-btn"><i class="fas fa-cog"></i><span
                                class="hrr-name"><?php echo e(L::_('Settings')); ?></span></a>
                    <div class="clearfix"></div>
                </div>
                <div class="hr-info mr-2">
                    <a title="<?php echo e($manga->name); ?>" href="<?php echo e(url('manga', ['m_id' => $manga->id, 'm_slug' => $manga->slug])); ?>" class="btn btn-sm hrr-btn"><i
                                class="fas fa-info"></i><span class="hrr-name"><?php echo e(L::_('Manga Detail')); ?></span></a>
                    <div class="clearfix"></div>
                </div>
...
</div><?php /**PATH D:\ANHNGHIA\HoiMeTruyen\resources\views/themes/mangareader/components/chapter/header.blade.php ENDPATH**/ ?>