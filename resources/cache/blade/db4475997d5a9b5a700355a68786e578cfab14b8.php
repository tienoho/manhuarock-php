            ...
            <div class="site-body">
                ...
                <div class="content-manga-left">
                    ...
                    <div class="panel-manga-chapter " id="chapterlist">
                        <h2 class="manga-panel-title "><i class="icofont-flash"></i> <?php echo e(L::_("Latest Chapter Releases")); ?></h2>
                        ...
                        <div class="chapter-readmore  c-chapter-readmore">
                            <span style="display: inline;"><?php echo e(L::_("Show more")); ?> <i class="icofont-simple-down"></i></span>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.manga18fx.layouts.full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/manhuarockz.com/resources/views/themes/manga18fx/pages/manga.blade.php ENDPATH**/ ?>