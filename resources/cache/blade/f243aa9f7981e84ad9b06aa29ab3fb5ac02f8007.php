                        ...
                        <div class="tab-pane show active" id="chart-today">
                            <div class="featured-block-ul featured-block-chart">
                                <ul class="ulclear">
                                    ...
                                    <?php if($i <= 3): ?> <li class="item-top">
                                        <?php else: ?>
                                        <li>
                                            <?php endif; ?>
                                            <div class="ranking-number">
                                                <?php if($i <= 9): ?> <span>0<?php echo e($i); ?></span>
                                                    <?php else: ?>
                                                    <span><?php echo e($i); ?></span>
                                                    <?php endif; ?>
                                            </div>
                                            <a class="manga-poster" href="<?php echo e(url('manga', ['m_slug' => $manga->slug, 'm_id' => $manga->id])); ?>"><img alt="<?php echo e($manga->name); ?>" class="manga-poster-img lazyload" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" data-src="<?php echo e($manga->cover); ?>"></a>
                                            <div class="manga-detail">
                                                <h3 class="manga-name">
                                                    <a href="<?php echo e(url('manga', ['m_slug' => $manga->slug, 'm_id' => $manga->id])); ?>" title="T<?php echo e($manga->name); ?>"><?php echo e($manga->name); ?></a></h3>
                                                <div class="fd-infor">
...
<?php /**PATH F:\PHP\HMT\resources\views/themes/mangareader/components/home/main-sidebar.blade.php ENDPATH**/ ?>