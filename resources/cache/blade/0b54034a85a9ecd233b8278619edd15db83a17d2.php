                            ...
                            <div class="tab-item wleft">
                                ...
                                <div class="form-items wleft">
                                    ...
                                    <div class="form-input">
                                      <span class="show ng-scope" id="transactionCode"><?php echo e(userget()->id); ?>00<?php echo e(mt_rand(11000, 99999)); ?></span>
                                      <input type="hidden" id="email" value="<?php echo e(userget()->email); ?>">
                                    </div>
                                </div>
                                <div class="form-items wleft">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.manga18fx.layouts.full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/manhuarockz.com/resources/views/themes/manga18fx/pages/addCoin.blade.php ENDPATH**/ ?>