    ...
    <div class="fed-part-case" id="main-content">
        <div class="wrap-content-part list-manga">
            <div class="header-content-part pl-sm-3 pr-sm-3 pl-md-3 pr-md-3 pl-lg-2 pr-lg-2">
                <div class="title"><?php echo e($heading_title); ?></div>
            </div>
...
<?php echo $__env->make('themes.kome.layouts.full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ANHNGHIA\HoiMeTruyen\resources\views/themes/kome/pages/manga-list.blade.php ENDPATH**/ ?>