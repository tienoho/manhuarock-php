                        ...
                        <div class="cate-sort float-right">
                            <div class="cs-item">
                                ...
                                <div class="dropdown-menu dropdown-menu-model" aria-labelledby="ssc-list">
                                    ...
                                    <?php if($sort !== $sort_id): ?>
                                    <a class="dropdown-item " href="<?php echo e(url($url, null, ['sort' => $sort_id])); ?>"><?php echo e($sort_name); ?></a>
                                    <?php else: ?>
                            ...
                            ?>
                                    ...
                                    <div class="fd-list">
                                        ...
                                        <div class="fdl-item">
                                            <div class="chapter">
                                                <a
                                                    href="<?php echo e(url('chapter', ['m_slug' => $manga->slug, 'c_slug' => $chapter->slug, 'c_id' => $chapter->id ])); ?>">
                        ...
                        <div class="pre-pagination mt-4">
                            <nav aria-label="Page navigation">
                                <ul class="pagination pagination-lg justify-content-center">
                                    <?php if(!($paginate->current_page <= 1)): ?> <?php $prev_page=$paginate->current_page - 1;
                                        ?>
                                        ...
                                        <?php for($page_in_loop = 1; $page_in_loop <= $paginate->total_page; $page_in_loop++): ?>
                                            ...
                                            <?php if(( $page_in_loop >= $paginate->current_page - 2 && $page_in_loop <=
                                                $paginate->current_page ) || ( $page_in_loop <= $paginate->current_page
                                                    ...
                                                    <?php if($page_in_loop == $paginate->current_page): ?>
                                                    <li class="page-item active">
                                                        <a data-page="<?php echo e($paginate->current_page); ?>" class="page-link"
                                                            href="<?php echo e(url($url, ['page' => $paginate->current_page], $params)); ?>"><?php echo e($paginate->current_page); ?></a>
                                                    </li>
                                                    <?php else: ?>
                                                    <li class="page-item">
                                                        <a data-page="<?php echo e($page_in_loop); ?>" class="page-link"
                                                            href="<?php echo e(url($url, ['page' => $page_in_loop], $params)); ?>"><?php echo e($page_in_loop); ?></a>
                                                    </li>
                                                    <?php endif; ?>
                                                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.mangareader.layouts.full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\PHP\HMT\resources\views/themes/mangareader/pages/manga-list.blade.php ENDPATH**/ ?>