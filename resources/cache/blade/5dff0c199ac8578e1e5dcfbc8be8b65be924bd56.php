            ...
            <div class="site-body">
                ...
                <div class="bixbox" style="margin-bottom: 30px;">
                    <div class="releases">
                        <h2>
                            <i class="icofont-flash"></i>
                            <?php echo e(L::_("Most Viewed")); ?>

                        </h2>
                    </div>
                    <div class="listupd">
                        <?php $__currentLoopData = (new Models\Manga())->trending_manga(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $manga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="hot-item">
                                <a href="<?php echo e(url('manga', ['m_slug' => $manga->slug, 'm_id' => $manga->id])); ?>"
                                   title="<?php echo e($manga->name); ?>">
                                    <div class="chapter-badges">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.manga18fx.layouts.full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/manhuarockz.com/resources/views/themes/manga18fx/pages/home.blade.php ENDPATH**/ ?>