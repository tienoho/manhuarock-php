                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input aria-invalid="true" name="chapter_index" type="number" class="form-control"
                                id="chapter_index" placeholder="VD: 1, 2, 3..." value="<?php echo e($chapter->chapter_index); ?>">
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\PHP\HMT\resources\views/admin/pages/chapter_edit.blade.php ENDPATH**/ ?>