                            ...
                            <div class="row align-items-end pb-3 pt-3">
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="max_process_running" value="<?php echo e($default_config['max_process_running']); ?>">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="max_page_update" value="<?php echo e($default_config['max_page_update']); ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            <div>
                                                <label class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="save_poster" <?php if($default_config['save_poster'] === 1): ?> checked="" <?php endif; ?>>
                                ...
                                <div class="form-selectgroup-boxes row">
                                    <div class="col-lg-6">
                                        <label class="form-selectgroup-item mb-2">
                                            <input type="radio" name="only_update" value="1" class="form-selectgroup-input" <?php if($default_config['only_update'] === 1): ?> checked="" <?php endif; ?>>
                                    ...
                                    <div class="col-lg-6 ">
                                        <label class="form-selectgroup-item mb-2">
                                            <input type="radio" name="only_update" value="0" class="form-selectgroup-input" <?php if($default_config['only_update']===0): ?> checked="" <?php endif; ?>>
...
<?php echo $__env->make('autosite.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/mangarock.top/resources/views/autosite/configuration.blade.php ENDPATH**/ ?>