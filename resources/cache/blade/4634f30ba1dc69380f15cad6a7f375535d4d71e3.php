                ...
                <div class="manga-body">
                    <div class="read-manga">
                        ...
                        <div class="text-center mt-3">
                            <button id="error_report" class="btn btn-warning"
                                    type="button"> <?php echo e(L::_("Error Report")); ?> </button>
                        </div>
                        ...
                        <div class="related-manga wleft">
                            <h4 class="manga-panel-title"><i
                                        class="icofont-star-shape"></i> <?php echo e(L::_("You May Also Like")); ?></h4>
...
<?php echo $__env->make('themes.manga18fx.layouts.full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/v2.manhuarockz.com/resources/views/themes/manga18fx/pages/chapter.blade.php ENDPATH**/ ?>