        ...
        <div class="ci-form">
            ...
            <form class="preform comment-form">
                ...
                <div class="ci-buttons" id="df-cm-buttons" style="display: none;">
                    <div class="ci-b-left">
                        <div class="cb-li">
                            <a class="btn btn-sm btn-spoil"><i class="fas fa-check mr-2"></i>Spoil?</a>
                        </div>
                    </div>
            ...
            <div class="info">
                ...
                <div class="ibottom">
                    <div class="ib-li ib-reply" data-id="<?php echo e($comment->id); ?>">
                        <a class="btn"><i class="fas fa-reply mr-1"></i><?php echo e(L::_('Reply')); ?></a>
                    </div>
                    ...
                    <div class="ib-li ib-dislike">
                        <a class="btn cm-btn-vote" data-id="<?php echo e($comment->id); ?>" data-type="0"> <i
                                    class="far fa-thumbs-down mr-1"></i><span class="value"></span> </a>
                    </div>
                    <div class="ib-li">
                        <a class="btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-ellipsis-h mr-1"></i><?php echo e(L::_('More')); ?></a>
                        <div class="dropdown-menu dropdown-menu-model dropdown-menu-normal" aria-labelledby="ssc-list">
                            <a class="dropdown-item cm-report" href="javascript:(0);" data-type="1"
                               data-id="<?php echo e($comment->id); ?>">
                                <?php echo e(L::_('Report Spam')); ?></a>
                            <a class="dropdown-item cm-report" href="javascript:(0);" data-type="2"
                               data-id="<?php echo e($comment->id); ?>"><?php echo e(L::_('Report Spoil')); ?></a>
                        </div>
                    </div>
                    <?php if(is_login()): ?>
                                ...
                                <form class="preform preform-dark comment-form">
                                    ...
                                    <div class="ci-buttons">
                                        ...
                                        <div class="ci-b-right">
                                            ...
                                            <div class="cb-li">
                                                <button class="btn btn-sm btn-primary ml-2"><?php echo e(L::_('Reply')); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                ...
                <div class="replies">
                    <div class="rep-more rep-in">
                        <button type="button" class="btn btn-sm cm-btn-show-rep" data-id="<?php echo e($comment->id); ?>">
                            <i class="fas fa-caret-down mr-2"></i><span><?php echo e(count($replys)); ?> <?php echo e(L::_('replies')); ?></span>
                        </button>
                    </div>
                                    ...
                                    <div class="ibottom">
                                        ...
                                        <div class="ib-li">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-model dropdown-menu-normal"
                                                ...
                                                <a class="dropdown-item cm-report" href="javascript:(0);" data-type="1"
                                                   data-id="<?php echo e($reply->id); ?>">Report
                                                    Spam</a>
                                                <a class="dropdown-item cm-report" href="javascript:(0);" data-type="2"
                                                   data-id="<?php echo e($reply->id); ?>">Report
                                                    Spoil</a>
                                        ...
                                        <div class="ci-form">
                                            <form class="preform preform-dark comment-form">
                                                ...
                                                <textarea class="form-control form-control-textarea" name="content"
                                                          maxlength="3000" placeholder="Add a reply"
                                                          required=""></textarea>
                                                <div class="ci-buttons">
                                                    <div class="ci-b-left">
                                                        <div class="cb-li"><a class="btn btn-sm btn-spoil"><i
                                                    ...
                                                    <div class="ci-b-right">
                                                        <div class="cb-li">
                                                            <a class="btn btn-sm btn-secondary btn-close-reply"
                                                               data-id="<?php echo e($reply->id); ?>">Close</a>
                                                        </div>
                                                        <div class="cb-li">
...
<?php /**PATH D:\ANHNGHIA\HoiMeTruyen\resources\views/themes/mangareader/components/ajax/comment.blade.php ENDPATH**/ ?>