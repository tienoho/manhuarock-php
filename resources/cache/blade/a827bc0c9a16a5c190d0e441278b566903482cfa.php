    ...
    <div class="header-bottom ">
        <div class="centernav">
            <ul>
                ...
                <?php endif; ?>
                <li>
                    <a href="<?php echo e(path_url("manga.history")); ?>" class="text-danger" title="<?php echo e(L::_("History")); ?>"><i class="icofont-history"></i> <?php echo e(L::_("History")); ?></a>
                </li>
                <li>
                    <a href="<?php echo e(url("completed")); ?>" title="<?php echo e(L::_("Completed")); ?>"> <?php echo e(L::_("Completed")); ?></a>
                </li>
                <li>
                    <a href="<?php echo e(url("most-viewed")); ?>" title="<?php echo e(L::_("Most Viewed")); ?>"> <?php echo e(L::_("Most Viewed")); ?></a>
                </li>
                <li class="dropdownmenu">
                    <a href="#" title="<?php echo e(L::_("Genres")); ?>"><?php echo e(L::_("Genres")); ?> <i class="icofont-caret-right"></i></a>
                </li>
...
<div class="header-manga mb-header ">
    ...
    <div class="under-header">
        <div class="header-menu" style="display: none;">
            <ul>
                <li>
                    <a href="<?php echo e(url('home')); ?>" title="<?php echo e(L::_("Home")); ?>"><i class="icofont-home"></i> <?php echo e(L::_("Home")); ?></a>
                </li>
                <li>
                    <a href="<?php echo e(url("manga_list")); ?>" title="<?php echo e(L::_("All Manga")); ?>"><?php echo e(L::_("All Manga")); ?></a>
                </li>
                <li>
                ...
                <li class="dropdownmenumb">
                    <a href="#" title="Manga List - Genres: All"><?php echo e(L::_("Genres")); ?> <i class="icofont-caret-right"></i></a>
                </li>
                <div class="sub-menumb" style="display: none;">
                    <ul>
                        <?php $__currentLoopData = Models\Taxonomy::GetListGenres(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="<?php echo e(url('genres', ['genres' => $genre->slug])); ?>" title="<?php echo e($genre->name); ?>"><i class="icofont-caret-right"></i><?php echo e($genre->name); ?></a>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
...
</div><?php /**PATH /www/wwwroot/manhuarockz.com/resources/views/themes/manga18fx/components/header.blade.php ENDPATH**/ ?>