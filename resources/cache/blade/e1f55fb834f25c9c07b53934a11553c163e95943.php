                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="setting-form" action="<?php echo e(url()); ?>" method="POST">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="site_url" type="text" class="form-control"
                                                           ...
                                                           value="<?php echo e($siteConf['site_url']); ?>">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="newupdate_home" type="text" class="form-control"
                                                           ...
                                                           value="<?php echo e($siteConf['newupdate_home']); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="general_page" type="text" class="form-control"
                                                           placeholder="Default: 24"
                                                           value="<?php echo e($siteConf['general_page']); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="total_related" type="text" class="form-control"
                                                           ...
                                                           value="<?php echo e($siteConf['total_related']); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="SBpopular" type="text" class="form-control"
                                                           placeholder="Default: 6"
                                                           value="<?php echo e($siteConf['SBpopular']); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="SBhistory" type="text" class="form-control"
                                                           placeholder="Default: 6"
                                                           value="<?php echo e($siteConf['SBhistory']); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="tag_footer" type="text" class="form-control"
                                                           ...
                                                           value="<?php echo e($siteConf['tag_footer']); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="analytics_id" type="text" class="form-control"
                                                           ...
                                                           value="<?php echo e($siteConf['analytics_id'] ?? NULL); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="FBAppID" type="text" class="form-control"
                                                           ...
                                                           value="<?php echo e($siteConf['FBAppID'] ?? NULL); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="label-row">
                                                ...
                                                <div class="input-group">
                                                    <input name="CacheTime" type="text" class="form-control"
                                                           ...
                                                           value="<?php echo e($siteConf['CacheTime'] ?? NULL); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input" name="is_cache"
                                                           <?php echo e(($siteConf['is_cache'] === 'on' ? 'checked' : '')); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/v2.manhuarockz.com/resources/views/admin/pages/settings.blade.php ENDPATH**/ ?>