...
<?php $__env->startSection('url', $chapter_url ?? url()); ?>
<?php $__env->startSection('image', $manga->cover); ?>

<?php $__env->startSection('data-id', $manga->id); ?>

<?php $__env->startSection('content'); ?>
<div id="wrapper" data-reading-id="<?php echo e($chapter->id ?? ''); ?>" data-reading-by="chap" data-lang-code="en"
                ...
                <div class="float-left">
                    <div class="rt-item">
                        <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                            class="btn"><?php echo e(L::_('Reading Mode')); ?>: <span id="current-mode">- <?php echo e(L::_('Select')); ?>
        ...
        <div id="first-read" style="display: none;">
            <div class="read-tips">
                <div class="read-tips-layout">
                    ...
                    <div class="description"><?php echo e(L::_('Select the reading mode you want. You can re-config in')); ?>

                        <strong class="ml-2"><i class="fas fa-cog mr-2"></i><?php echo e(L::_('Settings')); ?> > <?php echo e(L::_('Reading
                            Mode')); ?></strong>
                    </div>
                    <div class="rtl-rows">
            ...
            <div id="main-wrapper" class="page-layout page-read mb-0">
                <div class="page-read-setting">
                    <div class="anis-cover" style="background-image: url(<?php echo e($manga->cover ?? "
...
<?php echo $__env->make('themes.mangareader.layouts.read', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\PHP\HMT\resources\views/themes/mangareader/pages/chapter.blade.php ENDPATH**/ ?>