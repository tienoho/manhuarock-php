                ...
                <div class="content-chap-image" id="content_chap">
                    <div class="fed-part-case">
                        <div id="lst_content" class="lst_image text-center">
                            <div class="waiting" style="width: 100%; height: 800px"></div>
                        </div>
                    </div>
                    <br class="clear"></div>
            </div>
            ...
            <div class="modal fade" id="baoloi">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header"><h4 class="modal-title" id="myModalLabel">Report Chapter</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <p style="margin:20px 0;">
                                <button class="btn baoloibutton" style="width:150px;margin:0 auto;">Send report<i
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.kome.layouts.full', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ANHNGHIA\HoiMeTruyen\resources\views/themes/kome/pages/chapter.blade.php ENDPATH**/ ?>